...
from common import list_to_csv
...
class API(object):
    ...
    def __init__(self, auth_handler=None,
            ...
            parser=None, timeout=None, compression=None):
    ...
    user_timeline = bind_api(
        ...
        payload_type = 'status', payload_list = True,
        allowed_param = ['id', 'user_id', 'screen_name', 'since_id', 'max_id', 'count', 'page',
                         'include_rts', 'trim_user', 'include_entities', 'exclude_replies']
    )
    ...
    def lookup_users(self, user_ids=None, screen_names=None, include_entities=0):
